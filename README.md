...
xcodegen generate              # generates Ainkrad.xcodeproj from project.yml

# The project currently needs the beta toolchain:
export DEVELOPER_DIR=/Applications/Xcode-beta.app/Contents/Developer

open Ainkrad.xcodeproj         # ⌘R in Xcode
# …or from the command line:
xcodebuild -scheme Ainkrad -configuration Debug build
```

> `Ainkrad.xcodeproj` is generated by XcodeGen from `project.yml`. Run
> `xcodegen generate` after changing `project.yml`, and treat `project.yml` as
> the source of truth.
