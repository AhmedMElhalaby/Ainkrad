...
enum IslandLayers {
    static let all: [IslandLayer] = [
        ...
        IslandLayer(id: "Island-Blue-Cloud-0",  kind: .cloud,   cx: 0.3900, cy: 0.2200, width: 0.1500, z: 10, seed: 0),
        IslandLayer(id: "Island-Blue-Cloud-1",  kind: .cloud,   cx: 0.3800, cy: 0.6200, width: 0.1200, z: 11, seed: 1),
        IslandLayer(id: "Island-Blue-Cloud-2",  kind: .cloud,   cx: 0.3200, cy: 0.3800, width: 0.1100, z: 12, seed: 2),
        ...
        IslandLayer(id: "Island-Blue-Cloud-6",  kind: .cloud,   cx: 0.6800, cy: 0.3800, width: 0.1100, z: 16, seed: 6),
        ...
        IslandLayer(id: "Island-Blue-Cloud-9-1",  kind: .cloud,   cx: 0.3900, cy: 0.3800, width: 0.1100, z: 19, seed: 9),
        IslandLayer(id: "Island-Blue-Cloud-10-2",  kind: .cloud,   cx: 0.6700, cy: 0.7500, width: 0.1300, z: 20, seed: 10),
        IslandLayer(id: "Island-Blue-Cloud-11-3",  kind: .cloud,   cx: 0.6000, cy: 0.2800, width: 0.1100, z: 21, seed: 11),
        IslandLayer(id: "Island-Blue-Cloud-12-4",  kind: .cloud,   cx: 0.3500, cy: 0.3300, width: 0.1000, z: 22, seed: 12),
        IslandLayer(id: "Island-Blue-Cloud-13-5",  kind: .cloud,   cx: 0.6500, cy: 0.3300, width: 0.1000, z: 23, seed: 13),
        IslandLayer(id: "Island-Blue-Cloud-14-6",  kind: .cloud,   cx: 0.3600, cy: 0.3000, width: 0.0900, z: 24, seed: 14),
        IslandLayer(id: "Island-Blue-Cloud-15-7",  kind: .cloud,   cx: 0.7400, cy: 0.3000, width: 0.0900, z: 25, seed: 15),
        ...
        IslandLayer(id: "Island-Blue-Cloud-18-10",  kind: .cloud,   cx: 0.6000, cy: 0.1800, width: 0.1100, z: 28, seed: 18),
