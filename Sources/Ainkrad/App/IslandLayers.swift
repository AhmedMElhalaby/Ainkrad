...
enum IslandLayers {
    static let all: [IslandLayer] = [
        ...
        IslandLayer(id: "Island-Blue-Cloud-0",  kind: .cloud,   cx: 0.2900, cy: 0.5500, width: 0.2000, z: 11, seed: 0),
        IslandLayer(id: "Island-Blue-Cloud-1",  kind: .cloud,   cx: 0.7100, cy: 0.5700, width: 0.2000, z: 12, seed: 1),
        IslandLayer(id: "Island-Blue-Cloud-2",  kind: .cloud,   cx: 0.6700, cy: 0.3600, width: 0.1500, z: 13, seed: 2),
        IslandLayer(id: "Island-Blue-Cloud-3",  kind: .cloud,   cx: 0.7500, cy: 0.5000, width: 0.1100, z: 14, seed: 3),
        IslandLayer(id: "Island-Blue-Cloud-4",  kind: .cloud,   cx: 0.3300, cy: 0.3700, width: 0.1400, z: 15, seed: 4),
        IslandLayer(id: "Island-Blue-Cloud-5",  kind: .cloud,   cx: 0.2700, cy: 0.4800, width: 0.1000, z: 16, seed: 5),
        IslandLayer(id: "Island-Blue-Cloud-6",  kind: .cloud,   cx: 0.4000, cy: 0.2800, width: 0.0900, z: 17, seed: 6),
        IslandLayer(id: "Island-Blue-Cloud-7",  kind: .cloud,   cx: 0.3100, cy: 0.6300, width: 0.1000, z: 18, seed: 7),
        IslandLayer(id: "Island-Blue-Cloud-0",  kind: .cloud,   cx: 0.1900, cy: 0.6000, width: 0.1200, z: 19, seed: 8),
        IslandLayer(id: "Island-Blue-Cloud-1",  kind: .cloud,   cx: 0.8100, cy: 0.6000, width: 0.1200, z: 20, seed: 9),
        IslandLayer(id: "Island-Blue-Cloud-2",  kind: .cloud,   cx: 0.3300, cy: 0.7900, width: 0.1300, z: 21, seed: 10),
        IslandLayer(id: "Island-Blue-Cloud-3",  kind: .cloud,   cx: 0.6700, cy: 0.7900, width: 0.1300, z: 22, seed: 11),
        IslandLayer(id: "Island-Blue-Cloud-4",  kind: .cloud,   cx: 0.2200, cy: 0.4400, width: 0.1000, z: 23, seed: 12),
        IslandLayer(id: "Island-Blue-Cloud-5",  kind: .cloud,   cx: 0.7900, cy: 0.4400, width: 0.1000, z: 24, seed: 13),
        IslandLayer(id: "Island-Blue-Cloud-6",  kind: .cloud,   cx: 0.2900, cy: 0.8700, width: 0.1200, z: 25, seed: 14),
        IslandLayer(id: "Island-Blue-Cloud-7",  kind: .cloud,   cx: 0.7100, cy: 0.8700, width: 0.1200, z: 26, seed: 15),
        IslandLayer(id: "Island-Blue-Cloud-0",  kind: .cloud,   cx: 0.6000, cy: 0.2900, width: 0.1000, z: 27, seed: 16),
        IslandLayer(id: "Island-Blue-Cloud-1",  kind: .cloud,   cx: 0.2400, cy: 0.7100, width: 0.1000, z: 28, seed: 17),
        IslandLayer(id: "Island-Blue-Cloud-2",  kind: .cloud,   cx: 0.7600, cy: 0.7100, width: 0.1000, z: 29, seed: 18),
