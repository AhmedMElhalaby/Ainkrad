...
struct AssistantTypography: Equatable {
    ...
    static func resolve(family: UIFontFamily?, scale: UIFontScale?,
                        globalFamily: UIFontFamily, globalScale: UIFontScale) -> AssistantTypography {
        AssistantTypography(scale: (scale ?? globalScale).multiplier,
