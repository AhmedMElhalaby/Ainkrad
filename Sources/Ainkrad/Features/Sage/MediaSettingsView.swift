...
/// The Sage Settings "MEDIA" section: the image-generation provider picker
/// and its API key. Built from `AinkradSettingsPanel`, `AinkradCaptionedRow` for
/// single-field rows, and `SageSettingsLabeled` for the provider list;
    ...
    var body: some View {
        AinkradSettingsPanel(title: "Media",
            ...
            VStack(alignment: .leading, spacing: 12) {
                SageSettingsLabeled("Image provider", tokens: tokens) {
                    ProviderStatusList(
