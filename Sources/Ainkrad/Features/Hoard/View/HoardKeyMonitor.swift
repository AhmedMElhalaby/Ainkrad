...
/// Local `keyDown` monitor for Hoard' ⌥-chorded shortcuts.
///
...
/// unclaimed, so every Hoard chord that needs to work regardless of focus
/// lives here.
struct HoardKeyMonitor: NSViewRepresentable {
    let chords: [HoardOptionChord]
