...
struct HoardSettingsDocument: PersistableDocument {
...
@MainActor
@Observable
final class HoardSettingsStore {
    ...
    init(persistence: PersistenceStore) {
        ...
        let document = persistence.load(HoardSettingsDocument.self) ?? HoardSettingsDocument()
